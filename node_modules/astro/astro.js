#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/home/critian/.vscode/extensions/wallabyjs.console-ninja-1.0.312/out/buildHook/index.js').default({tool: 'astro'}); } catch(cjsError) { try { import('file:///home/critian/.vscode/extensions/wallabyjs.console-ninja-1.0.312/out/buildHook/index.js').then(m => m.default.default({tool: 'astro'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
